...
public abstract class ListTypeHandle<T> extends BaseTypeHandler<List<T>> {


    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, List<T> parameter, JdbcType jdbcType) throws SQLException {
        String content = CollUtil.isEmpty(parameter) ? JSON.toJSONString(Collections.EMPTY_LIST) : JSON.toJSONString(parameter);
